...
class ArcModule(nn.Module):
    def __init__(self, in_features, out_features, s=10, margin=0.5):
        super().__init__()
...
class EfficientNetArcFace(nn.Module):
    ...
    def __init__(self, channel_size, out_feature, margin, dropout=0.5, backbone='tf_efficientnet_b0_ns',
                 pretrained=True):
        ...
        self.margin = ArcModule(in_features=self.channel_size, out_features=self.out_feature, margin=margin)
